...
Desenvolvedor apaixonado por transformar ideias em soluções reais — com experiência prática em **Web, Mobile e Automações**. Construo interfaces modernas, aplico automações inteligentes e extraio valor dos dados para criar produtos que realmente fazem diferença.
